...
import { type BooleanModel, type ConstantModel, type Model, type NumberModel, type OptionalModel, type RecordModel, type StringModel, type TaggedUnionModel } from "@huanglangjian/schema"
...
export function generateRecordModel(model: RecordModel, context: GeneratorContext | ModuleGeneratorContext): string {
    ...
    const definationCode = `
        ...
        public record ${simpleName}(
            ...
            public ${simpleName} with(java.util.function.Consumer<Builder$> initializer){
